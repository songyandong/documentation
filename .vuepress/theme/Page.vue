    ...
    <footer class="page-footer">
        <div class="page-footer-content">
            <section class="copyright">
              <img :src="require('./images/logo_gray.png')" class="page-footer-logo" alt="logo">
              <div class="line-sep"></div>
              <span class="page-footer-copyright">Copyright &copy; {{ new Date().getFullYear() }} PPIO Inc.  All Rights Reserved.</span>
            </section>
            <nav class="page-footer-nav">
              <!-- <a class="social-link-fb" href="https://www.facebook.com/PPIO-178595523020994/" target="_blank" rel="nofollow external noopener">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                  <path d="M19 6h5V0h-5c-3.86 0-7 3.14-7 7v3H8v6h4v16h6V16h5l1-6h-6V7c0-.542.458-1 1-1z"/>
                </svg>
              </a> -->
              <a class="social-link-tw" href="https://twitter.com/PPLabs_PPIO" target="_blank" rel="nofollow external noopener">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
              ...
              <a href="https://medium.com/@ppio" class="social-link-medium" target="_blank" rel="nofollow external noopener">
              ...
              <a href="https://www.youtube.com/channel/UCFRyuBY-PxoSaFmj5Evs5kQ" class="social-link-youtube" target="_blank" rel="nofollow external noopener">
              ...
              <a href="https://www.linkedin.com/company/pplabs/" class="social-link-linkedin" target="_blank" rel="nofollow external noopener">
                <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="https://github.com/ppio" class="social-link-github" target="_blank" rel="nofollow external noopener">
                <svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
